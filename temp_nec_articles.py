...
def update_nec_articles_batch3():
    ...
    # List of updated NEC articles - simplified content to avoid syntax errors
    updated_articles = [
        {
            "article_number": "334",
        ...
        },
        {
            ...
            "content": "<h3>Article 404: Switches</h3><p>This article covers requirements for switches, switching devices, and circuit breakers used as switches.</p>"
        },
        {
            "article_number": "406",
            ...
            "content": "<h3>Article 406: Receptacles, Cord Connectors, and Attachment Plugs</h3><p>This article covers the rating, type, and installation of receptacles, cord connectors, and attachment plugs.</p>"
        },
        {
            "article_number": "422",
            "title": "Appliances",
